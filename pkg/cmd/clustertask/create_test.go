...
func TestCreate_TaskNotExist(t *testing.T) {
	...
	out, err := test.ExecuteCommand(clustertask, "create", "ct", "--from-task", "t-1")
	if err == nil {
...
func TestCreate(t *testing.T) {
	...
	out, err := test.ExecuteCommand(clustertask, "create", "ct-1", "--from-task", "t-1")
	if err != nil {
...
func TestCreate_InNamespace(t *testing.T) {
	...
	out, err := test.ExecuteCommand(clustertask, "create", "--from-task", "t-1", "-n", "ns")
	if err != nil {
		t.Errorf("Unexpected error: %v", err)
	}
...
func TestCreate_WithoutFlag(t *testing.T) {
	...
	expected := "Error: --from-task flag not passed\n"
	test.AssertOutput(t, expected, out)
}
