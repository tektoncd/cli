...
Ensure that golangci-lint and yamllint are installed on your development machine. If not then install them following [golangci-lint](https://golangci-lint.run/welcome/install/) and [yamllint](https://yamllint.readthedocs.io/en/stable/quickstart.html).
