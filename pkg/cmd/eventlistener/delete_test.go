...
func TestEventListenerDelete(t *testing.T) {
	...
	testParams := []struct {
		...
		},
		{
			...
			inputStream: nil,
			wantError:   true,
			want:        "failed to delete eventlistener \"nonexistent\": eventlisteners.tekton.dev \"nonexistent\" not found; failed to delete eventlistener \"nonexistent2\": eventlisteners.tekton.dev \"nonexistent2\" not found",
		},
		{
