...
* Mac OS X
  ...
  - Or by the [released tarball](https://github.com/tektoncd/cli/releases/download/v0.17.0/tkn_0.17.0_Darwin_x86_64.tar.gz):
...
* Windows
  ...
  - Uncompress the [zip file](https://github.com/tektoncd/cli/releases/download/v0.17.0/tkn_0.17.0_Windows_x86_64.zip)
...
* [Linux AMD 64](https://github.com/tektoncd/cli/releases/download/v0.17.0/tkn_0.17.0_Linux_x86_64.tar.gz)
...
* [Linux ARM 64](https://github.com/tektoncd/cli/releases/download/v0.17.0/tkn_0.17.0_Linux_arm64.tar.gz)
...
* [Linux IBM Z](https://github.com/tektoncd/cli/releases/download/v0.17.0/tkn_0.17.0_Linux_s390x.tar.gz)
...
* [Linux IBM P](https://github.com/tektoncd/cli/releases/download/v0.17.0/tkn_0.17.0_Linux_ppc64le.tar.gz)
...
### Linux RPMs
  ...
  * [Binary RPM package](https://github.com/tektoncd/cli/releases/download/v0.17.0/tektoncd-cli-0.17.0_Linux-64bit.rpm)
...
### Linux Debs
  ...
  * [Binary DEB package](https://github.com/tektoncd/cli/releases/download/v0.17.0/tektoncd-cli-0.17.0_Linux-64bit.deb)
