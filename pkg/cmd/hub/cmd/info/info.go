...
import (
	...
	"github.com/tektoncd/cli/pkg/cmd/hub/flag"
	"github.com/tektoncd/cli/pkg/cmd/hub/formatter"
	"github.com/tektoncd/cli/pkg/cmd/hub/hub"
	so "github.com/tektoncd/cli/pkg/cmd/hub/options"
	"github.com/tektoncd/cli/pkg/cmd/hub/printer"
...
func commandForKind(kind string, opts *options) *cobra.Command {
	...
	return &cobra.Command{
		Use:          kind,
		Short:        "Display info of " + cases.Title(language.English).String(kind) + " by its name, catalog and version",
		Long:         ``,
		SilenceUsage: true,
