...
Provides: bundled(golang(github.com/prometheus/client_golang/prometheus/promhttp)) = v1.11.1
Provides: bundled(golang(github.com/prometheus/client_golang/prometheus/internal)) = v1.11.1
