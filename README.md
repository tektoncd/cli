...
* [Linux ARM 64](https://github.com/tektoncd/cli/releases/download/v0.8.0/tkn_0.8.0_Linux_arm64.tar.gz)
...
#### Linux RPMs
  ...
  * [Binary RPM package](https://github.com/tektoncd/cli/releases/download/v0.8.0/tektoncd-cli-0.8.0_Linux-64bit.rpm)
...
#### Linux Debs
  ...
  * [Binary DEB package](https://github.com/tektoncd/cli/releases/download/v0.8.0/tektoncd-cli-0.8.0_Linux-64bit.deb)
